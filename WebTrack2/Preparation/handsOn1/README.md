...
# 세션은 앞에 있는 진행자도 함께 진행합니다. 이 자료는 세션 강연자의 속도에 맞출 필요 없이 세션이 쉽게 느껴지시는 분들은 빠르게, 어렵게 느껴지시는 분들은 천천히 따라하실 수 있게 도움을 드리고자 작성되었습니다. 자율적으로 세션을 진행해주세요.

### 만약 이론적인 내용이 궁금하신 분들은 세션 진행자 혹은 라이트닝 토크 형식으로 질문해주시거나, [사용할 AWS 서비스 살펴보기](/WebTrack2/Preparation/lecture1)와 [React와 CRA](/WebTrack2/Preparation/lecture2)를 참고하시기 바랍니다.
